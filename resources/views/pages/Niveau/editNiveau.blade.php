@extends('layouts.master', ['title' => 'Modifier Niveau'])
    ...
    <div id="cont" class="container">
        ...
        <form action="{{ route('addNiveau') }}" method="POST" >
            ...
            <div class="mb-3">
                ...
                <input class="form-control" type="number" name="numero" id="" value="{{ $niveau->numero }}">
            </div>
            <div class="mb-3">
                ...
                <select name="cycle_id" id="" class="form-select">
                    ...
                    @foreach ($niveau as $niveau)
                        @if($niveau->id == $specialite->filieres_id)
